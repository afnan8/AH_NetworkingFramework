...
- (void)testUIImageViewSetImagewithURL {
    ...
    // test setImageWithURL for default case
    BOOL testRequestIsInBackground = [AH_Networking sharedInstance].isRequestRunInBackground;

    XCTAssertFalse(testRequestIsInBackground);
